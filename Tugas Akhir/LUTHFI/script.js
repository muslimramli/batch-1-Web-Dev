var background = {}
  ...
  background.initializr = function (){
    ...
    $this.object = $("<div style='z-inde:-1;margin:0;padding:0; overflow:hidden;position:absolute;pointer-events: none ;bottom:0' id='"+$this.id+"'> </div>'").appendTo(".animasi");
    ...
    $(".animasi").prepend("<style>.shape_background {transform-origin:center; width:80px; height:80px; background: "+$this.style.bubbles_color+"; position: absolute}</style>");
